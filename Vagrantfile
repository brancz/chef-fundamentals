...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "flower-pot-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/pondati"
  #   chef.validation_client_name = "pondati-validator"
  #   chef.validation_key_path = ".chef/pondati-validator.pem"
  # end
end
